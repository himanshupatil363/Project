                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group"><label class="form-control-label">Surname :
                                                </label> <input class="form-control @error('last_name') is-invalid @enderror" name="last_name" type="text"
                                                    placeholder="Enter your surname name"></div>
                                                      @error('last_name')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class=form-group><label class="form-control-label">Class in which
                                                    admission sought :</label> <input class="form-control" name="class" type="text"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="btn-group-toggle d-flex mt-2" data-toggle="buttons">
                                                <label class="btn btn-lg btn-neutral btn-icon flex-fill mr-sm-4 active">
                                                    ...
                                                    <input type="radio" name="billing_entity" name="gender" value="male" id="male">Male
                                                </label>
                                                <label class="btn btn-lg btn-neutral flex-fill ml-sm-4">
                                                    <i class="fas fa-venus"></i>
                                                    <input type="radio" name="billing_entity" name="gender" value="female" id="female">Female
                                                </label>
                                            </div>
                                              @error('gender')
                                    <span class="text-danger" role="alert">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"><label class="form-control-label">Birthday :</label>
                                                <input type="text" class="form-control" data-toggle="date"
                                                    placeholder="Select your birth date" x-model="dob" name="dob" @blur=' $refs.age.value=moment().diff(dob,"years")'></div>
                                                      @error('dob')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"><label class="form-control-label">Age : </label>
                                                <input class="form-control" disabled type="number" name="age" minlength="0" maxlength="100" x-ref="age" placeholder="Age" required ></div>
                                                  @error('age')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" data-toggle="select" title="Country"
                                                    data-live-search="true" name="nationality" data-live-search-placeholder="Country">
                                                    <option disabled="disabled" selected="selected">Select option
                                                    </option>
                                ...
                                @enderror
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" data-toggle="select" title="Country"
                                                    data-live-search="true" name="religion" data-live-search-placeholder="Country">
                                                    <option disabled="disabled" selected="selected">Select option
                                                    </option>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="form-group"><label class="form-control-label">Mother
                                                    Tongue:</label> <input class="form-control" name="mother_tongue" type="text"
                                                    placeholder="Mother Tongue"></div>
                                                  @error('email')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="form-group"><label class="form-control-label">Student's
                                                    Aadhar Number :</label> <input class="form-control" name="aadhar" type="text"
                                                    placeholder="Enter Aadhar number"></div>
                                                      @error('email')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
<div class='row'>
                                ...
                                @enderror
                                        ...
                                        @if ($child=="2")
                                         <div class="col-md-12">
                                            <div class="form-group"><label class="form-control-label">Number of Brother / Sister studying in this School 
                                                </label> <input class="form-control" name="sibling_count" wire:model="count" type="text"
                                ...
                                @enderror
                                        ...
                                        @for ($i = 0; $i < $count; $i++)
                                           <div class="col-md-6">
                                            <div class="form-group"><label class="form-control-label">Name :
                                                </label><input class="form-control" type="text" name="sibling_name[]" required placeholder="Name">
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group"><label class="form-control-label">Class :
                                                </label> <input class="form-control" type="text" name="sibling_class[]" required placeholder="Class">

                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group"><label class="form-control-label">Section :
                                                </label> <input class="form-control" type="text" name="sibling_section[]" required placeholder="Section">
...
<hr>
                                        ...
                                        <div class="col-sm-12">
                                            <div class=form-group><label class=form-control-label>Address :</label>
                                                <textarea class=form-control type=text
                                                  name="address"  placeholder="Enter your home address"></textarea>
                                            </div>
                                              @error('email')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                @enderror
                                        ...
                                        <div class="col-sm-6" wire:ignore>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="country" data-toggle="select" title="Country"
                                ...
                                @enderror
                                     ...
                                     <div class="mt-3">
                                        <button type="sumbit" class="btn btn-sm btn-primary"
                                            onclick="confirmation()">Save</button>
                                        <button type="reset" class="btn btn-sm btn-danger"
                                            onclick="confor()">Reset</button>
                                    </div>
                                </form>
                            </div>
                        </div>
